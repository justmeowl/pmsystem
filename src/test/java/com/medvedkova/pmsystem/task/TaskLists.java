...
public class TaskLists {
    ...
    public static List<Task> createFirstTaskList() {
        ...
        taskList.get(2-1).addConnection(new Connection(1));
        taskList.get(3-1).addConnection(new Connection(2));
        taskList.get(5-1).addConnection(new Connection(3));
        taskList.get(4-1).addConnection(new Connection(6));
        taskList.get(4-1).addConnection(new Connection(5));
        taskList.get(6-1).addConnection(new Connection(5));
        taskList.get(7-1).addConnection(new Connection(4));
        taskList.get(8-1).addConnection(new Connection(5));
        taskList.get(9-1).addConnection(new Connection(5));
        taskList.get(10-1).addConnection(new Connection(7));
        taskList.get(10-1).addConnection(new Connection(9));
        taskList.get(11-1).addConnection(new Connection(8));
        taskList.get(11-1).addConnection(new Connection(10));
        taskList.get(12-1).addConnection(new Connection(11));
        return taskList;
    }

    public static List<Task> createSecondTaskList() {
        ...
        t2.addConnection(new Connection(6));
